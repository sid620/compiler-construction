...
/*
    This function removes all comments and stores the cleaned code in the filename passed to the function (parameter:cleanFile).
    Default filename is "commentremoval.txt".
*/
